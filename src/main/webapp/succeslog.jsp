...
<section class="p-5  text-center"
        ...
        <h3 class="text-center font-weight-bold text-light-dark pb-2 mb-4" style="margin-top: 100px">Welcome <% out.println(username); %>! You have logged in on our website.</h3>
</section>
</body>
</html>
